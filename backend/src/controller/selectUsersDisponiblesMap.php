...
// Obtener IDs de usuarios que ya están en el mapa mental
$stmt = $conn->prepare("SELECT usuario_id FROM miembros_mapas_mentales WHERE mapa_mental_id = ?");
