...
$espacio_id = $input['espacio_trabajo_id'];
...
// Obtener IDs de usuarios que ya están en el espacio de trabajo
$stmt = $conn->prepare("SELECT usuario_id FROM miembros_espacios_trabajo WHERE espacio_trabajo_id = ?");
