...
header("Access-Control-Allow-Origin: http://$server:5173");
...
// Obtener IDs de usuarios que ya están en el tablero
$stmt = $conn->prepare("SELECT usuario_id FROM miembros_tableros WHERE tablero_id = ?");
